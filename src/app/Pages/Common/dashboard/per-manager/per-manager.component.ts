...
@Component({
  selector: "app-per-manager",
  templateUrl: "./per-manager.component.html",
  styleUrls: ["./per-manager.component.css"],
})
export class PerManagerComponent implements OnInit, OnDestroy {
  constructor(
  ...
  @ViewChild("PerManager", { static: true })
